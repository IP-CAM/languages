...
$_['entry_title']            = 'Назва метода оплаты';
...
//Help
$_['help_title']             = 'Назва метода оплаты на странице оформления заказа';
$_['help_button_confirm']    = 'Назва кнопки \'button_confirm\' на финальном шаге страницы оформления заказа';
