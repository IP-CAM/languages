...
$_['entry_recurring']          	= 'Профілі с регулярными платежами';
...
$_['help_points']          		= 'Кількість баллов для покупки товара. Поставьте 0, чтобы товар нельзя было приобрести за бали.';
...
$_['error_permission']          = 'У Вас немає прав для зміни товаров!';
