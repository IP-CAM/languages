...
$_['text_shipping_cod']           		= 'Наложенным платежем';
...
$_['text_returns_type_exch']    		= 'Повернення денег или обмен';
$_['text_returns_costs']        		= 'Возвращение транспортные расходы';
$_['text_returns_costs_b']      		= 'Покупець оплачивает';
...
$_['text_type_returns']       			= 'Поверненняы';
$_['text_type_template']       			= 'Галерея шаблонов';
$_['text_type_general']       			= 'Основные настройки';

//Success messages
$_['text_added']                		= 'Новый профиль добавлен';
$_['text_updated']              		= 'Профіль обновлен';

//Errors
$_['error_permission']        			= 'У Вас недостаточно прав для изменения профіля';
$_['error_name']           				= 'Вы должны ввести имя профіля';
